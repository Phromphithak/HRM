...
const SalarySlip = () => {
  ...
  const { employeeId, selectedDate } = useParams();
  useEffect(() => {
  ...
  const filteredPayHistory = employeeData?.payrollInformation.payHistory
    .filter(historyItem => !selectedDate || historyItem.date === selectedDate);
  console.log('SaralySlip.log ', employeeData);
  console.log('Selected Date:', selectedDate);
  console.log('Filtered Pay History:', filteredPayHistory);
    ...
    <Container>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>
                {selectedDate &&
                  employeeData.payrollInformation.payHistory
                    .filter(historyItem => historyItem.date === selectedDate)
                    .reduce((total, filteredHistoryItem) => total + filteredHistoryItem.salary,'')
                }
              </TableCell>
            ...
            <TableRow>
              ...
              <TableCell>{selectedDate &&
                  employeeData.payrollInformation.payHistory
                    .filter(historyItem => historyItem.date === selectedDate)
                    .reduce((total, filteredHistoryItem) => total + filteredHistoryItem.overtime,'')
                }</TableCell>
            </TableRow>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>{selectedDate &&
                  employeeData.payrollInformation.payHistory
                    .filter(historyItem => historyItem.date === selectedDate)
                    .reduce((total, filteredHistoryItem) => total + filteredHistoryItem.taxDeduction,'')
                }</TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>{selectedDate &&
                  employeeData.payrollInformation.payHistory
                    .filter(historyItem => historyItem.date === selectedDate)
                    .reduce((total, filteredHistoryItem) => total + filteredHistoryItem.loanRepayment,'')
                }</TableCell>
            </TableRow>
      ...
      {filteredPayHistory.length > 0 && (
        <Typography variant="caption" sx={{ marginTop: 2 }}>
          Salary Slip Issued on:
            {filteredPayHistory.map((filteredHistoryItem, index) => (
              <li key={index}>{filteredHistoryItem.date}</li>
            ))}
        </Typography>
      )}
